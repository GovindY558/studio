                            ...
                            <CardContent className="flex flex-col items-center justify-center p-6 space-y-8 min-h-[500px]">
                                <RevealCard coverContent={<p className="text-lg">A little something to help your inner artist shine...</p>}>
                                    <div className="flex flex-col items-center text-center">
                                        ...
                                        <p className="mt-4 font-body text-lg max-w-prose">I know how much you love creating beautiful things. This is to help you capture every perfect angle. Can't wait to see what you create!</p>
                                    </div>
                                </RevealCard>
                            </CardContent>
                        </Card>
