    ...
    <AlertDialog open={showEnableDialog}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Babygirl this website has custom background music for each page to make it special. Would you like to enable it for the best experience? Also Volume Badhana and agar koi aaspas ho to earphone pehananna..
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
