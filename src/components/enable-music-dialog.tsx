    ...
    <AlertDialog open={showEnableDialog}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This website has custom background music for each page to make it special. Would you like to enable it for the best experience? Remember to turn up your volume!
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
